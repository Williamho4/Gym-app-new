function WorkoutPlan() {
  ...
  return (
    <div className="main-color min-h-[46rem] max-h-[46rem] rounded-xl w-[100%] md:w-[80%] lg:w-[70%] xl:w-[40%] m-3 flex flex-col items-center shadow-xl p-2.5 xl:p-6">
      <h1 className="text-xl mt-3.5 xl:mt-0 tracking-wider">Workout Monday</h1>
      <ul className="w-full mt-3 flex flex-wrap overflow-auto justify-between custom-scrollbar">
        {exercises.map((exercise) => (
          <li className="secondary-color h-[10rem] w-[46%] md:w-[44%] xl:w-[46%] rounded-md m-2 mb-3 flex pt-2 pb-2 pl-2 shadow-xl">
            <img
              src={exercise.img}
              alt={exercise.name}
